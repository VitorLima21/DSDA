            ...
            <table className="table table-striped table-bordered">
                ...
                <tbody>
                    ...
                    {professores.map((dados) => (
                        ...
                        <tr key={dados.professsor_id} >
                            <td>{dados.professsor_id}</td>
                            <td>{dados.nome}</td>
                            <td>{dados.email}</td>
                            <td>{dados.telefone}</td>
                            <td>{dados.especialidade}</td>
                            <td className="d-flex justify-content-center">
                                <Link to={`/professores/editar/${dados.professsor_id}`} className="btn btn-sm btn-primary me-2">
                                ...
                                <button onClick={() => deleteProfessor(dados.professsor_id)} className="btn btn-sm btn-danger me-2">
